...
export const CartPage = ():JSX.Element=> {
  ...
  return (
    <Box sx={{display: 'flex',justifyContent:"center" ,alignItems:"center",flexDirection:"column",marginTop:{xl:10,xs:2}}}>
      <StoreIcon sx={{color :"rgba(169, 182, 201, 0.6)",fontSize:80}}/>
    ...
    {" "}
        <Grid container sx={{display: 'flex',flexDirection:"column",alignContent:"center"}}>
            {cart?.map((cartProduct: any ,index:any ) => (
              
            <CartContainer  key={cartProduct.id} cartProduct={cartProduct} />
        ...
        <Button variant="contained" sx={{marginBottom:2}} onClick={openModal}>Comprar</Button>
        <Dialog open={isModalOpen} onClose={closeModal}>
        <DialogTitle>Esta apunto de realizar una compra</DialogTitle>
